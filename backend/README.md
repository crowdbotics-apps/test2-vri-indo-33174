...
## Project Structure
    ...
    ├── test2_vri_indo_33174  # Django project configurations
...
1. Clone this repo and `cd test2_vri_indo_33174`
...
2. Clone this repo and `cd test2_vri_indo_33174`
